...
import { MoreHorizontal, Mail, Phone, CalendarCheck, Edit, Trash2 } from "lucide-react"
import {
  Table,
  TableBody,
  TableCell,
...
export function CustomerTable({ customers, onViewProfile, onEdit, onDelete }: CustomerTableProps) {
  return (
